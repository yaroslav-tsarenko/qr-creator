...
const translations = {
    ...
    el: {
        formTitle: "Επικοινωνία",
        formDesc: "Συμπληρώστε τη φόρμα παρακάτω και θα επικοινωνήσουμε μαζί σας το συντομότερο δυνατό.",
        firstName: "Όνομα",
        secondName: "Επώνυμο",
        email: "Email",
        phone: "Τηλέφωνο",
        ...
        send: "Αποστολή",
        successMsg: "Ευχαριστούμε! Τα δεδομένα σας στάλθηκαν επιτυχώς!",
        successAlertTitle: "Επιτυχία",
        successAlertMsg: "Το αίτημά σας στάλθηκε!",
        errorAlertTitle: "Σφάλμα",
        errorAlertMsg: "Αποτυχία αποστολής. Δοκιμάστε ξανά.",
        directContact: "Άμεση επικοινωνία",
    },
    da: {
        formTitle: "Kontakt Os",
        formDesc: "Udfyld formularen nedenfor, og vi vender tilbage så hurtigt som muligt.",
        firstName: "Fornavn",
        ...
        send: "Send",
        successMsg: "Tak! Dine data er sendt!",
        successAlertTitle: "Succes",
        successAlertMsg: "Din anmodning er sendt!",
        errorAlertTitle: "Fejl",
        errorAlertMsg: "Kunne ikke sende. Prøv igen.",
        directContact: "Direkte kontakt",
    },
    hu: {
        formTitle: "Kapcsolat",
        formDesc: "Töltse ki az alábbi űrlapot, és a lehető leghamarabb válaszolunk.",
        firstName: "Keresztnév",
        secondName: "Vezetéknév",
        email: "E-mail",
        phone: "Telefonszám",
        message: "Üzenet (opcionális)",
        send: "Küldés",
        successMsg: "Köszönjük! Az adatok sikeresen elküldve!",
        successAlertTitle: "Sikeres",
        successAlertMsg: "Kérése elküldve!",
        errorAlertTitle: "Hiba",
        errorAlertMsg: "Sikertelen küldés. Kérjük, próbálja újra.",
        directContact: "Közvetlen kapcsolat",
    },
};
